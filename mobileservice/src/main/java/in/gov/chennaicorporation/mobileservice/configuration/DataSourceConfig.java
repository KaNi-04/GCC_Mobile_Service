...
//	 private static String dbpassword = "root";
	...
	////////////////////////////// For Construction Payment ////////////////////////
	@Bean(name = "mysqlConstructionPaymentDataSource")
	public DataSource mysqlConstructionPaymentDataSource() {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
		dataSource.setUrl("jdbc:mysql://" + host + "/construction_payment");
		dataSource.setUsername("root");
		dataSource.setPassword(dbpassword);
		return dataSource;
	}
	...
	////////////////////////////// For Night Shelter Inspection ////////////////////////
	@Bean(name = "mysqlNightShelterInspectionDataSource")
	public DataSource mysqlNightShelterInspectionDataSource() {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
		dataSource.setUrl("jdbc:mysql://" + host + "/gcc_night_shelter_inspection");
		dataSource.setUsername("root");
		dataSource.setPassword(dbpassword);
		return dataSource;
	}
	...
	//////////Road war web//////////////////////
	@Bean(name = "mysqlroadwarwebGccDataSource")
	public DataSource mysqlroadwarwebGccDataSource() {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
