...
@Service
public class c_d_WasteUserService {
	private JdbcTemplate jdbcUserWasteTemplate;
	...
	public void setDataSource(
			@Qualifier("mysqlC_D_WasteUserDataSource") DataSource wasteUserDataSource,
			@Qualifier("mysqlPGRMasterDataSource") DataSource pgrDataSource
			) {
		this.jdbcUserWasteTemplate = new JdbcTemplate(wasteUserDataSource);
		this.jdbcPGRTemplate = new JdbcTemplate(pgrDataSource);
	}
	
	@Autowired
	public c_d_WasteUserService(Environment environment) {
	...
	public String fileUpload(String name, String id, MultipartFile file) {
        ...
        uploadDirectory = uploadDirectory + serviceFolderName+"web_user/" + year +"/"+month+"/"+date;
        ...
        try {
	        ...
	        String filepath_txt = "/"+serviceFolderName + "web_user/" + year + "/" + month + "/" + date + "/" + fileName;
	...
	public String fileUrlUpload(String name, String id, String fileUrl) {
	    ...
	    uploadDirectory = uploadDirectory + serviceFolderName + "web_user/" + year + "/" + month +"/reply";
	    ...
	    try {
	        ...
	        String relativeFilePath = "/" + serviceFolderName + "web_user/" + year + "/" + month + "/reply/" + fileName; // Relative path to save in DB
	...
	@Transactional
	public List<Map<String, Object>> saveUserWaste(
			String latitude,
			String longitude, 
			String zone, 
			String ward,
		...
		String sqlQuery = "INSERT INTO `waste_location_mapping`"
				+ "(`zone`, `ward`, `cby`, `latitude`, `longitude`, `address`, `tonage`, `file`, `status`,`type`,`request_by_type`,`ref_id`) "
				+ "VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		try {
			...
			String tonagetxt = tonage; 
			
			int affectedRows = jdbcUserWasteTemplate.update(new PreparedStatementCreator() {
				@Override
	...
	public List<Map<String, Object>> getMyticketllist(String loginId) {
        String sql = "SELECT  "
        		+ "    `wlid` AS comp_id,  "
        		+ "    `zone` AS comp_zone,  "
        		+ "    `ward` AS comp_ward,  "
...
//    }
	...
	public List<Map<String, Object>> getApprovalPendingList(String loginId, String ward, String type) {
	    ...
	    sql.append("SELECT ")
	       ...
	       .append(" waste_location_mapping.user_mobile AS comp_contact, ")
	       .append(" waste_location_mapping.user_name AS comp_name, ")
	    ...
	    return jdbcUserWasteTemplate.queryForList(sql.toString(), params.toArray());
	}
	...
	public List<Map<String, Object>> checkApprovalLocation(String comp_id, String latitude, String longitude) {
	    ...
	    List<Map<String, Object>> result = jdbcUserWasteTemplate.queryForList(sql, new Object[]{comp_id, latitude, longitude, latitude});
	...
	public List<Map<String, Object>> saveApproval(
	    ...
	    int rowsAffected = jdbcUserWasteTemplate.update(sql, new Object[]{
	        status, loginId, reject_txt, latitude, longitude, in_out, final_vendor_approval, formattedDate, tonage_kg, comp_id
	    });
	...
	public List<Map<String, Object>> get2ApprovalPendingList(String loginId, String ward) {
        ...
        return jdbcUserWasteTemplate.queryForList(sql,loginId, ward);
    }
	...
	public List<Map<String, Object>> getZoneWiseCount(String fromDATE, String toDATE, String requestBy) {
        ...
        return jdbcUserWasteTemplate.queryForList(sql, formattedFromDate, formattedToDate);
    }
	...
	public List<Map<String, Object>> getWardWiseCount(String fromDATE, String toDATE, String zone, String requestBy) {
        ...
        return jdbcUserWasteTemplate.queryForList(sql, zone, formattedFromDate, formattedToDate);
    }
	...
	public List<Map<String, Object>> getListByStatus(String fromDATE, String toDATE, String zone, String ward, String status, String requestBy) {
        ...
        return jdbcUserWasteTemplate.queryForList(sql, zone, ward, status, formattedFromDate, formattedToDate);
    }
	...
	public List<Map<String, Object>> getWardSumReport(String ward) {
	    ...
	    List<Map<String, Object>> result = jdbcUserWasteTemplate.queryForList(sql, ward, formattedFromDate, formattedToDate);
	...
	public List<Map<String, Object>> getTicketDetailsByWLID(String wlid) {
	    ...
	    return jdbcUserWasteTemplate.queryForList(sql, wlid);
	}
}
