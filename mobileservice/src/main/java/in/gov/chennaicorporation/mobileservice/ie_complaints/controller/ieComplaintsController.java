...
public class ieComplaintsController {
        ...
        public List<Map<String, Object>> getFeedbackQuestions(
                        @RequestParam(value = "flow_ref_id", required = false) String flow_ref_id,
                        @RequestParam(value = "complaint_id", required = false) String complaint_id,
                        @RequestParam(value = "loginId", required = false) String loginId) {
                return iecomplaintservice.getParentQuestionsList(flow_ref_id, complaint_id, loginId);
        }
