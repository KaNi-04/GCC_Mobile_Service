    ...
    (i.d = function (e, t) {
        ...
        (function () {
            ...
            function Y(e) {
                ...
                return i && ("html" === S(i) || ("body" === S(i) && "static" === z(i).position))
                    ? t
                    : i ||
                          (function (e) {
            ...
            function te(e) {
                ...
                if (f) {
                    var S = Y(i),
                        O = "clientHeight",
                        j = "clientWidth";
                    S === C(i) && "static" !== z((S = R(i))).position && "absolute" === u && ((O = "scrollHeight"), (j = "scrollWidth")),
                ...
                return (
                    ...
                    (y = P.y),
                    p
                        ? Object.assign({}, D, (((T = {})[A] = E ? "0" : ""), (T[k] = x ? "0" : ""), (T.transform = (L.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + y + "px)" : "translate3d(" + b + "px, " + y + "px, 0)"), T))
                        : Object.assign({}, D, (((t = {})[A] = E ? y + "px" : ""), (t[k] = x ? b + "px" : ""), (t.transform = ""), t))
                );
            }
            var ie = {
                    name: "computeStyles",
                    ...
                    : fe(
                          (function (e) {
                              var t,
                                  ...
                                  a = -s.scrollLeft + de(e),
                                  l = -s.scrollTop;
                              return "rtl" === z(n || i).direction && (a += N(i.clientWidth, n ? n.clientWidth : 0) - o), { width: o, height: r, x: a, y: l };
                          })(R(e))
                      );
            }
            function me(e) {
                    ...
                    if (!t.modifiersData[d]._skip) {
                        for (
                                    ...
                                    return e.concat(
                                        P(i) === a
                                            ? (function (e, t) {
                                              ...
                                              })(t, { placement: i, boundary: v, rootBoundary: y, padding: b, flipVariations: E, allowedAutoPlacements: k })
                                            : i
                                    );
                                }, []),
                                O = t.rects.reference,
                            ...
                            var F = C[M],
                                ...
                                W = [s, n].indexOf(I) >= 0,
                                $ = W ? "width" : "height",
                                H = _e(t, { placement: F, boundary: v, rootBoundary: y, altBoundary: w, padding: b }),
                                z = W ? (q ? o : r) : q ? n : s;
                            O[$] > j[$] && (z = re(z));
                            var B = re(z),
                                R = [];
                        ...
                        if (S) {
                            ...
                            if (u) {
                                var he,
                                    ...
                                    xe = ve ? fe + C[ge] + O[ge] - ye - T.altAxis : be,
                                    Ee =
                                        b && ve
                                            ? (function (e, t, i) {
                                                  var s = K(e, t, i);
            ...
            var je = Oe(),
                Te = Oe({ defaultModifiers: [ne, Ee, ie, D, xe, be, ke, G, we] }),
                De = Oe({ defaultModifiers: [ne, Ee, ie, D] });
            ...
            class ai extends wt {
                ...
                _directionToOrder(e) {
                    return Ye() ? (e === Bt ? zt : Ht) : e === Bt ? Ht : zt;
                }
                _orderToDirection(e) {
                    return Ye() ? (e === zt ? Bt : Rt) : e === zt ? Rt : Bt;
                }
                static jQueryInterface(e) {
                    return this.each(function () {
            ...
            class Vi extends wt {
                ...
                _getPlacement() {
                    ...
                    return e.classList.contains("dropup") ? (t ? Wi : qi) : t ? Hi : $i;
                }
                _detectNavbar() {
            ...
            class Ss extends wt {
                ...
                show(e) {
                    this._isShown ||
                        ...
                        ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(xs), this._adjustDialog(), this._backdrop.show(() => this._showElement(e)));
                }
                hide() {
                    this._isShown &&
                        !this._isTransitioning &&
                ...
                _hideModal() {
                    (this._element.style.display = "none"),
                        ...
                        (this._isTransitioning = !1),
                        this._backdrop.hide(() => {
                            document.body.classList.remove(xs), this._resetAdjustments(), this._scrollBar.reset(), pt.trigger(this._element, fs);
                        });
                }
                _isAnimated() {
            ...
            pt.on(document, Hs, '[data-bs-toggle="offcanvas"]', function (e) {
                const t = Fe(this);
            ...
            const mn = ".bs.scrollspy",
                ...
                wn = "[href]",
                xn = ".nav-link",
                En = `${xn}, .nav-item > ${xn}, .list-group-item`,
            ...
            class Ln extends wt {
                ...
                _activateParents(e) {
                    ...
                    else for (const t of Ot.parents(e, ".nav, .list-group")) for (const e of Ot.prev(t, En)) e.classList.add(yn);
                }
                _clearActiveClass(e) {
            ...
            const Sn = ".bs.tab",
                ...
                $n = "fade",
                Hn = "show",
                zn = ":not(.dropdown-toggle)",
                Bn = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
                Rn = `.nav-link${zn}, .list-group-item${zn}, [role="tab"]${zn}, ${Bn}`,
            ...
            class Vn extends wt {
                ...
                _activate(e, t) {
                    e &&
                        ...
                        this._queueCallback(
                            () => {
                                "tab" === e.getAttribute("role") ? (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), pt.trigger(e, Tn, { relatedTarget: t })) : e.classList.add(Hn);
                            },
                            e,
                ...
                _deactivate(e, t) {
                    e &&
                        ...
                        this._queueCallback(
                            () => {
                                "tab" === e.getAttribute("role") ? (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), pt.trigger(e, On, { relatedTarget: t })) : e.classList.remove(Hn);
                            },
                            e,
                            e.classList.contains($n)
                        ));
                ...
                _toggleDropDown(e, t) {
                    ...
                    s(".dropdown-toggle", Wn), s(".dropdown-menu", Hn), i.setAttribute("aria-expanded", t);
                }
            ...
            pt.on(document, Dn, Bn, function (e) {
                ["A", "AREA"].includes(this.tagName) && e.preventDefault(), He(this) || Vn.getOrCreateInstance(this).show();
            }),
                pt.on(window, Nn, () => {
            ...
            var Qo = Object.freeze({ __proto__: null, addClasses: zo, classNamesToQuery: Ro, getElementDocument: $o, getElementWindow: Wo, getOptions: Ho, removeClasses: Bo }),
                Vo = Wo,
                Yo = $o,
                Xo = Ho,
                Ko = zo,
                ...
                _uiHandleDarkMode() {
                    ...
                    if (
                        ("init" !== e ||
                            ...
                            (t._lPage.classList.contains("sidebar-dark") ? localStorage.setItem("dashmixDefaultsSidebarDark", !0) : localStorage.removeItem("dashmixDefaultsSidebarDark"),
                            t._lPage.classList.contains("page-header-dark") ? localStorage.setItem("dashmixDefaultsPageHeaderDark", !0) : localStorage.removeItem("dashmixDefaultsPageHeaderDark")),
                        ...
                        document.querySelectorAll('[data-toggle="theme"]').forEach((s) => {
                            s.addEventListener("click", (n) => {
                                ...
                                document.querySelectorAll('[data-toggle="theme"]').forEach((e) => {
                                    ...
                                    (t = document.getElementById("css-theme")),
                                    i && localStorage.setItem("dashmixThemeName", o);
                            });
                        });
                }
                _uiUpdateTheme(e, t) {
                ...
                _uiApiLayout() {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init",
                        ...
                        i = {
                            ...
                            dark_mode_off: () => {
                                localStorage.getItem("dashmixDefaultsSidebarDark") || t._lPage.classList.remove("sidebar-dark"),
                                    localStorage.getItem("dashmixDefaultsPageHeaderDark") || t._lPage.classList.remove("page-header-dark"),
